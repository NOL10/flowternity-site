      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
        ...
        <a href="#" className="flex items-center gap-2.5">
          <div className="relative flex h-9 w-9 items-center justify-center">
            ...
            <span className="relative font-[var(--font-heading)] text-xl font-bold text-primary">F</span>
          </div>
          <span className="font-[var(--font-heading)] text-base font-semibold uppercase tracking-[0.25em] text-foreground">
            Flowternity
          </span>
        </a>
