          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5">
              <div className="relative flex h-8 w-8 items-center justify-center">
                ...
                <span className="relative font-[var(--font-heading)] text-lg font-bold text-primary">F</span>
              </div>
              <span className="font-[var(--font-heading)] text-sm font-semibold uppercase tracking-[0.25em] text-foreground">
                Flowternity Sports
              </span>
            </div>
