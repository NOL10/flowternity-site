              ...
              >
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input id="age" type="number" required min="4" max="18" value={formData.age}
              ...
              <div>
                ...
                <div className="flex gap-3">
                  ...
                  <RazorpayPayment
                    ...
                    description={`${selectedCamps.length} camp(s) for ${formData.childName}`}
                    email={formData.email}
